...
int main(int argc, char *argv[]) {
  ...
  double *fitness_scores = (double *)calloc(POP_SIZE, sizeof(double));
  ...
  printf(
      ...
      best_individual.layers, best_individual.neurons,
      best_individual.learning_rate, best_individual.batch_size,
      best_individual.activation);
